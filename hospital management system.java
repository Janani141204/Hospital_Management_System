...
class HealthcareSystem {
    ...
    public boolean bookAppointment(String patientId, String doctorId, String time) {
        ...
        for (Doctor d : doctors) {
            ...
            { 
            doctor = d; break;
             }  // Use getter to access doctorId
        }
        if (patient == null || doctor == null || !doctor.isSlotAvailable(time)) {
            System.out.println("Booking failed.");
            return false;
        }
        Appointment appointment = new Appointment("APT" + (appointments.size() + 1), patientId, doctorId, time);
        appointments.add(appointment);
            ...
            if (p.getPatientId().equals(patientId)) {
                ...
                if (patientAppointments.isEmpty()) {
                    ...
                    for (Appointment app : patientAppointments) {
                        System.out.println("Appointment ID: " + app.getAppointmentId() + ", Time: " + app.getTime() + ", Status: " + app.getStatus());
                    }
                }
                return;
            }
